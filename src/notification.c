...
void notif_layer_push_notif(const char *title, const char *content, int vibrate){
	switch(vibrate){
		case 1:
			vibes_short_pulse();
			break;
	...
	animate_layer(notif_layer->root_layer, &GRect(0, 0, 144, 168), &GRect(0, 170, 144, 168), 600, 5000);
}